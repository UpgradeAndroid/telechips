...
extern void sensor_info_init_hi704(TCC_SENSOR_INFO_TYPE *sensor_info);
extern void sensor_init_fnc_hi704(SENSOR_FUNC_TYPE *sensor_func);
...
/* The HI704 I2C sensor chip has a fixed slave address of 0x42. */

...
static SCANCODE_MAPPING key_mapping[] = 
{
	...
	{SCAN_CH_UP,		205},	// PAGE_UP
	{SCAN_CH_DN,		206},	// PAGE_DOWN
...
#if 1
	{SCAN_CENTER,		232},	// DPAD_CENTER
#else
	{SCAN_CENTER,		28},	// ENTER
#endif

	{SCAN_AUTO_CHANNEL,	234},	// F2
	{SCAN_ADD_DELETE,	14},	// DEL
	{SCAN_SIZE,			243},	// F11
	{SCAN_MULTI_SOUND,	244},	// F12

	{SCAN_STOP, 		199},	// MEDIA_STOP
	{SCAN_PLAY,			198},	// MEDIA_PLAY_PAUSE
	{SCAN_PAUSE,		198},	// MEDIA_PLAY_PAUSE
	{SCAN_REC,			207},	// NOTIFICATION
#if 1
	{SCAN_FB,			201},	// MEDIA_REWIND
	{SCAN_FF,			202},	// MEDIA_FAST_FORWARD
#else
	{SCAN_FB,			204},	// MEDIA_PREVIOUS
	{SCAN_FF,			203},	// MEDIA_NEXT
#endif
	{SCAN_CURRENT,		15},	// TAB
};

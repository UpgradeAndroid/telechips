...
struct lcd_panel ed090na_panel = {
	...
	.fswc2		= 10,
	.fewc2		= 25,
	.sync_invert	= IV_INVERT_EN | IH_INVERT_EN | IP_INVERT_EN,
...
static int ed090na_probe(struct platform_device *pdev)
{
	...
	gpio_request(TCC_GPC(24), "lcd_stbyb");
	...
	gpio_direction_output(TCC_GPC(24), 1);

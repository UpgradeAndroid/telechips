...
static int axp192_dcdc_set_voltage(struct regulator_dev *rdev, int min_uV, int max_uV)
{
...
static int axp192_ldo_set_voltage(struct regulator_dev *rdev, int min_uV, int max_uV)
{
    struct axp192_data* axp192 = rdev_get_drvdata(rdev);
    int id = rdev_get_id(rdev);

...
static struct tcc_freq_table_t gtClockLimitTable[] = {
	/*  CPU /   DDI /   MEM /   GPU /    IO /  VBUS /  VCOD /   SMU /  HSIO /   CAM */
	{ 100000,  74000, 160000,      0,  72000,      0,      0,  50000,      0,      0 },
	{ 144000,  74000, 160000,      0,  99000,      0,      0,  50000,      0,      0 },
...
#else
	{ 600000, 297000, 400000,      0,      0, 336000, 336000,      0,      0,      0 },	// Core 1.32V	// Not recommanded value
#endif
};
...
#else
	  800000, 297000, 400000,      0,      0, 336000, 336000,      0,      0,      0	// Core 1.32V	// Not recommanded value
#endif
};
...
#else
	  800000, 336000, 400000,      0, 198000,      0,      0,      0,      0,      0	// Core 1.32V
#endif
};

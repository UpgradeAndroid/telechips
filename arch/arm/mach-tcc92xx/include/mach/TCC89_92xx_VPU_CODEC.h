 ...
 ***********************************************************************
 */
#ifndef _TCC89_92XX_VPU_CODEC_H_
#define _TCC89_92XX_VPU_CODEC_H_
...
//Reason of "RETCODE_CODEC_SPECOUT" error
...
#define WORK_BUF_SIZE			(( 512 * 1024 ) + ( FMO_SLICE_SAVE_BUF_SIZE * 1024 * 8 ) + 100 * 1024) // 868K
...
#define	SLICE_SAVE_SIZE			0x100000 //0x040000
...
typedef struct enc_output_t 
{
	...
	int	m_iFrameAverageQp;			//!< Average Qp of the encoded frame
...
#endif//_TCC89_92XX_VPU_CODEC_H_

...
static struct tcc_freq_table_t gtClockLimitTable[] = {
...
#if (1)
	{ 343750, 155150, 300000, 184000,  97470, 137750, 137750,  97470,      0 },
	{ 401250, 189010, 322885, 224140, 118735, 167800, 167800, 100000,      0 },
	{ 468750, 222860, 380710, 264290, 140000, 197860, 197860, 100000,      0 },
	{ 546875, 267425, 456860, 317140, 168000, 237425, 237425, 100000,      0 },
	{ 625000, 312000, 533000, 370000, 196000, 277000, 277000, 100000,      0 },
	{ 718750, 349440, 534000, 414400, 219520, 310240, 310240, 100000,      0 },
	{ 812500, 386880, 534000, 458800, 243040, 343480, 343480, 100000,      0 },
#else
	...
	{ 718750,      0, 534000,      0, 219520,      0,      0, 100000,      0 },	// Core 1.25V
	{ 812500,      0, 534000,      0, 243040,      0,      0, 100000,      0 },	// Core 1.30V
...
const struct tcc_freq_table_t gtCameraClockLimitTable[] =
{
	...
	{      0, 222860, 533000,      0,      0,      0,      0,      0,      0 },	// Core 1.30V
};
...
{
	{      0, 222860, 380710,      0, 140000, 197860, 197860,      0,      0 },	// Core 1.10V
	{      0, 222860, 533000,      0, 196000, 277000, 277000,      0,      0 },	// Core 1.20V
	{      0, 222860, 533000,      0, 243040, 343480, 343480,      0,      0 },	// Core 1.30V
};
...
const struct tcc_freq_table_t gtHdmiClockLimitTable = {
	       0, 386880, 533000,      0, 243040,      0,      0,      0,      0	// Core 1.30V
};
...
const struct tcc_freq_table_t stFBClockLimitTable = {
	       0, 155150, 265050,      0,  97470,      0,      0,      0,      0	// Core 1.00V
};
...
const struct tcc_freq_table_t gtBtClockLimitTable = {
	       0,      0, 533000,      0, 196000,      0,      0,      0,      0	// Core 1.32V
};
...
const struct tcc_freq_table_t gtAppClockLimitTable = {
	  600000,      0, 533000,      0,      0,      0,      0,      0,      0	// Core 1.32V
};
...
const struct tcc_freq_table_t gtHSIOClockLimitTable = {
	       0,      0, 533000,      0,      0,      0,      0,      0, 250000	// Core 1.25V
};
...
const struct tcc_freq_table_t gtVoipClockLimitTable[] = {
	{      0,      0, 380710,      0, 196000,      0,      0,      0,      0 },	// Core 1.10V
	{      0,      0, 533000,      0, 196000,      0,      0,      0,      0 },	// Core 1.32V
};

...
static struct tcc_freq_table_t gtClockLimitTable[] = {
	...
	{ 100000,      0, 160000,      0,  72000,      0,      0,  50000,      0 },
	{ 144000,      0, 160000,      0,  99000,      0,      0,  50000,      0 },
	{ 200000,      0, 160000,      0, 108000,      0,      0,  50000,      0 },	// Core 0.95V
	{ 300000,      0, 160000,      0, 112000,      0,      0,  75000,      0 },
	{ 400000,      0, 160000,      0, 125000,      0,      0, 100000,      0 },	// Core 1.00V
	{ 500000,      0, 200000,      0, 148000,      0,      0, 125000,      0 },	// Core 1.05V
	{ 600000,      0, 240000,      0, 148000,      0,      0, 150000,      0 },	// Core 1.10V
	{ 700000,      0, 280000,      0, 172000,      0,      0, 175000,      0 },	// Core 1.15V
	{ 800000,      0, 320000,      0, 198000,      0,      0, 200000,      0 },	// Core 1.20V
	{ 900000,      0, 360000,      0, 220000,      0,      0, 225000,      0 },	// Core 1.25V
	{ 996000,      0, 400000,      0, 250000,      0,      0, 250000,      0 },	// Core 1.32V
#if defined(CONFIG_CPU_HIGHSPEED)
	{1200000,      0, 400000,      0, 250000,      0,      0, 250000,      0 },	// Core 1.45V
#endif
};
...
{
	{      0, 147000, 280000,      0,      0,      0,      0,      0,      0 },	// Core 1.20V
	{      0, 221000, 280000,      0,      0,      0,      0,      0,      0 },	// Core 1.20V
	{      0, 297000, 320000,      0,      0,      0,      0,      0,      0 },	// Core 1.20V	// do not verify for Full HD
};

const struct tcc_freq_table_t gtISPCameraClockLimitTable[] =
{
	{      0, 147000, 200000,      0,      0,      0,      0,      0,      0 },	// Core 1.20V
	{      0, 221000, 240000,      0,      0,      0,      0,      0,      0 },	// Core 1.20V
	{      0, 297000, 320000,      0,      0,      0,      0,      0,      0 },	// Core 1.20V	// do not verify for Full HD
};

const struct tcc_freq_table_t gtVpuNormalClockLimitTable[] =
{
	{      0, 147000, 160000,      0,      0, 150000, 145000,      0,      0 },	// Core 1.00V	// D1
	{      0, 221000, 240000,      0,      0, 225000, 218000,      0,      0 },	// Core 1.10V	// HD
	{      0, 297000, 400000,      0,      0, 336000, 297000,      0,      0 },	// Core 1.32V	// Not recommanded value
};
...
const struct tcc_freq_table_t gtHdmiClockLimitTable = {
	       0, 336000, 400000,      0, 198000,      0,      0,      0,      0	// Core 1.32V
};

const struct tcc_freq_table_t gtMaliClockLimitTable = {
	       0,      0, 320000, 322000,      0,      0,      0,      0,      0	// Core 1.20V
};

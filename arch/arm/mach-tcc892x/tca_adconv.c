...
unsigned int    tca_adc_adcinitialize(unsigned int devAddress, void* param )
{
	...
	pTSADC->ADCDLY.nREG = ADC_DELAY(220);	
...
////////////////read x
		...
		BITCSET(pTSADC->ADCCON.nREG,Hw6-Hw3,  Hw6);
		...
		//read x value
		*y= D_XPDATA_MASK12(pTSADC->ADCDAT0.nREG);
		pTSADC->ADCTSC.nREG = ADCTSC_AUTO_ADC5;
...
////////////////read y
		...
		//read y value
		*x= D_XPDATA_MASK12(pTSADC->ADCDAT1.nREG);
...
////////////////read Z2
		...
		*ym= D_XPDATA_MASK12(pTSADC->ADCDAT0.nREG);
		...
		//*ym=0;
		BITSET(pTSADC->ADCCON.nREG, Hw2);//Standby
		BITCLR( pTSADC->ADCTSC.nREG , ADCTSC_AUTO_ADC5);	// Auto Conversion
...
////////////////read Z1
		...
		*xp= D_XPDATA_MASK12(pTSADC->ADCDAT0.nREG);
////////////////read x
		pTSADC->ADCTSC.nREG = Hw3|Hw2|Hw0;
		//gpio setting - 30 high
...
////////////////read y
		pTSADC->ADCTSC.nREG = Hw3|Hw2|Hw1;
		//gpio setting - 31,28 high
		BITCSET(pTSADC->ADCCON.nREG,Hw6-Hw3,  Hw6|Hw3);
		pTSADC->ADCCON.nREG |= ENABLE_START_EN;	// ADC Conversion Start

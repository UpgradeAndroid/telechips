/*
 * linux/arch/arm/mach-tcc93xx/board-tcc9300cm.c
 *
...
static void tcc9300cm_nand_init(void)
{
...
static int tcc9300cm_nand_ready(void)
{
...
struct tcc_nand_platform_data tcc_nand_platdata = {
	...
	.init		= tcc9300cm_nand_init,
	.ready		= tcc9300cm_nand_ready,
};
...
MACHINE_START(TCC9300CM, "tcc9300cm")

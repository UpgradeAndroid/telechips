...
struct tcc_uart_port tcc_serial_ports[NR_PORTS] = {
	[0] = {
		...
		.base_addr      = tcc_p2v(HwUARTCH0_BASE),
        .name = "uart0"
	},
	[1] = {
		.port = {
        ...
        .base_addr      = tcc_p2v(HwUARTCH1_BASE),
        .name = "uart1"
	},
	[2] = {
		.port = {
        ...
        .base_addr      = tcc_p2v(HwUARTCH2_BASE),
        .name = "uart2"
	},
	[3] = {
		.port = {
        ...
        .base_addr      = tcc_p2v(HwUARTCH3_BASE),
        .name = "uart3"
	},
	[4] = {
		.port = {
        ...
        .base_addr      = tcc_p2v(HwUARTCH4_BASE),
        .name = "uart4"
	},
	[5] = {
		.port = {
        ...
        .base_addr      = tcc_p2v(HwUARTCH5_BASE),
        .name = "uart5"
	},
};
...
{
	volatile PUARTPORTMUX pPortmux = (volatile PUARTPORTMUX)tcc_p2v(HwUARTPORTMUX_BASE);
...
//	printk("\n%s: ch:%d, nPort:%d\n\n", __func__, nPort, phy_port);
	...
	switch (phy_port) {//do port set
	case 0:
#if 1
		BITCSET(pGPIO->GPEFN0, 0x000000FF, 0x00000011);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPEFN0, 0x0000FF00, 0x00001100);
#else
		BITCSET(pGPIO->GPGFN2, 0x000000FF, 0x00000022);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPGFN1, 0xFF000000, 0x22000000);
#endif
		break;
	case 1:
#if defined(CONFIG_MACH_TCC9300) || defined(CONFIG_MACH_TCC9300CM)
		BITCSET(pGPIO->GPEFN0, 0x00FF0000, 0x00110000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPEFN0, 0xFF000000, 0x11000000);
#elif defined(CONFIG_MACH_TCC9300ST)
		BITCSET(pGPIO->GPGFN3, 0x00FF0000, 0x00220000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPGFN3, 0x0000FF00, 0x00002200);
#endif
		break;
	case 2:
#if defined(CONFIG_MACH_TCC9300) || defined(CONFIG_MACH_TCC9300CM)
		BITCSET(pGPIO->GPEFN1, 0x000000FF, 0x00000011);
#elif defined(CONFIG_MACH_TCC9300ST)
		BITCSET(pGPIO->GPGFN0, 0xFF000000, 0x22000000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPGFN0, 0x00FF0000, 0x00220000);
#endif
		break;
	case 3:
#if 1
		BITCSET(pGPIO->GPEFN1, 0x0000FF00, 0x00001100);
#else
		BITCSET(pGPIO->GPGFN1, 0x000FF000, 0x00022000);
#endif
		break;
	case 4:
#if 1
		BITCSET(pGPIO->GPDFN1, 0x0FF00000, 0x01100000); 
		if (hw_flow_ctrl) {
			BITCSET(pGPIO->GPDFN1, 0xF0000000, 0x10000000);
			BITCSET(pGPIO->GPDFN2, 0x0000000F, 0x00000001);
		}
#else
		BITCSET(pGPIO->GPGFN2, 0x00000FF0, 0x00000220);
#endif
		break;
	case 5:
		BITCSET(pGPIO->GPDFN2, 0x00000FF0, 0x00000110); 
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPDFN2, 0x000FF000, 0x00011000);
		break;
	}
}
...
//	printk("\n%s: ch:%d, nPort:%d\n\n", __func__, nPort, phy_port);
	...
	case 0:
#if 1
		BITCSET(pGPIO->GPEFN0, 0x000000FF, 0x00000000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPEFN0, 0x0000FF00, 0x00000000);
#else
		BITCSET(pGPIO->GPGFN2, 0x000000FF, 0x00000000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPGFN1, 0xFF000000, 0x00000000);
#endif
		break;
	case 1:
#if defined(CONFIG_MACH_TCC9300) || defined(CONFIG_MACH_TCC9300CM)
		BITCSET(pGPIO->GPEFN0, 0x00FF0000, 0x00000000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPEFN0, 0xFF000000, 0x00000000);
#elif defined(CONFIG_MACH_TCC9300ST)
		BITCSET(pGPIO->GPGFN3, 0x00FF0000, 0x00000000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPGFN3, 0x0000FF00, 0x00000000);
#endif
		break;
	case 2:
#if defined(CONFIG_MACH_TCC9300) || defined(CONFIG_MACH_TCC9300CM)
		BITCSET(pGPIO->GPEFN1, 0x000000FF, 0x00000000);
#elif defined(CONFIG_MACH_TCC9300ST)
		BITCSET(pGPIO->GPGFN0, 0xFF000000, 0x00000000);
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPGFN0, 0x00FF0000, 0x00000000);
#endif
		break;
	case 3:
#if 1
		BITCSET(pGPIO->GPEFN1, 0x0000FF00, 0x00000000);
#else
		BITCSET(pGPIO->GPGFN1, 0x000FF000, 0x00000000);
#endif
		break;
	case 4:
#if 1
		BITCSET(pGPIO->GPDFN1, 0x0FF00000, 0x00000000); 
		if (hw_flow_ctrl) {
			BITCSET(pGPIO->GPDFN1, 0xF0000000, 0x00000000);
			BITCSET(pGPIO->GPDFN2, 0x0000000F, 0x00000000);
		}
#else
		BITCSET(pGPIO->GPGFN2, 0x00000FF0, 0x00000000);
#endif
		break;
	case 5:
		BITCSET(pGPIO->GPDFN2, 0x00000FF0, 0x00000000); 
		if (hw_flow_ctrl)
			BITCSET(pGPIO->GPDFN2, 0x000FF000, 0x00000000);
		break;
	}

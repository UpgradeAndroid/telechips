/*
 * arch/arm/mach-tcc93xx/board-tcc9300.h
 *
...
#ifndef __ARCH_ARM_MACH_TCC93XX_BOARD_TCC9300_H
#define __ARCH_ARM_MACH_TCC93XX_BOARD_TCC9300_H

#define GPIO_NAND_RDY		TCC_GPB(29)
#define GPIO_NAND_WP		TCC_GPA(19)
...
// DxB
#define GPIO_DXB2_SFRM		TCC_GPE(8)
#define GPIO_DXB2_SCLK		TCC_GPE(9)
#define GPIO_DXB2_RST		TCC_GPB(26)
#define INT_DXB2_IRQ		TCC_GPG(11)
#define GPIO_DXB2_SDI		TCC_GPE(10)
#define GPIO_DXB2_SDO		TCC_GPE(11)

#define GPIO_DXB1_SFRM		TCC_GPC(31)
#define GPIO_DXB1_SCLK		TCC_GPC(30)
#define GPIO_DXB1_SDI		TCC_GPC(29)
#define GPIO_DXB1_SDO		TCC_GPC(28)
#define GPIO_DXB1_RST		TCC_GPG(10)
#define INT_DXB1_IRQ		TCC_GPG(12)

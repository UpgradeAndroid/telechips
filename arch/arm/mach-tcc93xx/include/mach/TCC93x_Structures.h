...
/************************************************************************
*   TCC93x Internal Register Definition File
************************************************************************/
#ifndef __TCC93xSTRUCTURES_H__
#define __TCC93xSTRUCTURES_H__

#if defined(CONFIG_TCC_HDMI_UI_SIZE_1280_720)
#define SCREEN_WIDTH			1280 //LCD_WIDTH
#define SCREEN_HEIGHT			720 //LCD_HEIGHT
#else
#ifdef  CONFIG_FB_TCC92XX_HVGA_LMS350DF01
#define SCREEN_WIDTH			320 //LCD_WIDTH
#define SCREEN_HEIGHT			480 //LCD_HEIGHT
#elif defined(CONFIG_FB_TCC92XX_WVGA_LMS480KF)||defined(CONFIG_FB_TCC92XX_WVGA_LB070WV6)
#define SCREEN_WIDTH			800 //LCD_WIDTH
#define SCREEN_HEIGHT			480 //LCD_HEIGHT
#elif defined(CONFIG_FB_TCC92XX_WVGA_DX08D11VM0AAA)
#define SCREEN_WIDTH			480 //LCD_WIDTH
#define SCREEN_HEIGHT			800 //LCD_HEIGHT
#elif defined(CONFIG_FB_TCC89XX_XGA_CLAA104XA01CW)
#define SCREEN_WIDTH			1024 //LCD_WIDTH
#define SCREEN_HEIGHT			768 //LCD_HEIGHT
#elif defined(CONFIG_FB_TCC89XX_WXGA_HT121WX2)
#define SCREEN_WIDTH			1280 //LCD_WIDTH
#define SCREEN_HEIGHT			800 //LCD_HEIGHT
#elif defined(CONFIG_FB_TCC92XX_QVGA_HTD240000D)
#define SCREEN_WIDTH			240 //LCD_WIDTH
#define SCREEN_HEIGHT			320 //LCD_HEIGHT
#else
#define SCREEN_WIDTH			800 //LCD_WIDTH
#define SCREEN_HEIGHT			480 //LCD_HEIGHT
#endif//
...
/*******************************************************************************
*    TCC9300 DataSheet PART 2 SMU & PMU_V0.01 Dec.11 2008
********************************************************************************/
/************************************************************************
*   1. Clock Controller Register Define         (Base Addr = 0xB0500000)
************************************************************************/
//#define   HwCKC_BASE                                  *(volatile unsigned long*)0xB0500000

typedef struct _CKC{
    volatile unsigned int   CLK0CTRL;               //   0x00  R/W  0x002FF014  CPU Clock Control Register
    volatile unsigned int   CLK1CTRL;               //   0x04  R/W  0x002FF014  Bus Clock Control Register for Display Bus
    volatile unsigned int   CLK2CTRL;               //   0x08  R/W  0x000FF014  Bus Clock Control Register for Memory Bus
    volatile unsigned int   CLK3CTRL;               //   0x0C  R/W  0x000FF014  Bus Clock Control Register for Graphic Bus
    volatile unsigned int   CLK4CTRL;               //   0x10  R/W  0x000FF014  Bus Clock Control Register for Peipheral Bus
    volatile unsigned int   CLK5CTRL;               //   0x14  R/W  0x000FF014  Bus Clock Control Register for Video Bus
    volatile unsigned int   CLK6CTRL;               //   0x18  R/W  0x002FF014  Core Clock Control Register for Video Bus
    volatile unsigned int   CLK7CTRL;               //   0x1C  R/W  0x002FF014  Bus Clock Control Register for SMU
    volatile unsigned int   CLK8CTRL;               //   0x20  R/W  0x000FF014  Bus Clock Control Register for HSIO Bus
    volatile unsigned int   CLK9CTRL;               //   0x24  R/W  0x000FF014  Bus Clock Control Register for Camera Bus
    volatile unsigned int   CLK10CTRL;              //   0x28  R/W  0x000FF014  Bus Clock Control Register for Display Sub Bus
    volatile unsigned int   MBUSCTRL;               //   0x2C  R/W  0x07FFFC04  MBUS Clock Controller
    volatile unsigned int   PLL0CFG;                //   0x30  R/W  0x00004B03  PLL0 Configuration Register
    volatile unsigned int   PLL1CFG;                //   0x34  R/W  0x00004B03  PLL1 Configuration Register
    volatile unsigned int   PLL2CFG;                //   0x38  R/W  0x00004B03  PLL2 Configuration Register
    volatile unsigned int   PLL3CFG;                //   0x3C  R/W  0x00082943  PLL3 Configuration Register
    volatile unsigned int   PLL4CFG;                //   0x40  R/W  0x00082943  PLL4 Configuration Register
    volatile unsigned int   PLL5CFG;                //   0x44  R/W  0x00082943  PLL5 Configuration Register
    volatile unsigned int   CLKDIVC;                //   0x48  R/W  0x81818181  PLL0/1/2/3/ Divider Configuration Register
    volatile unsigned int   CLKDIVC1;               //   0x4C  R/W  0x00008181  XIN/XTIN Divider Configuration Register
    volatile unsigned int   CLKDIVC2;               //   0x50  R/W  0x81810000  PLL4/5 Divider Configuration Register
    volatile unsigned int   NOTDEFINE0[2];          //-  0x54-0x58      Reserved
    volatile unsigned int   SWRESET;                //   0x5C  R/W  0x00000000  Functional Bus Software Reset Control Register
    volatile unsigned int   HCLKMASK_CFG;           //   0x60  R/W  0x00000000  Functional Bus CFG Block Clock Mask Control Register
    volatile unsigned int   SWRESET_CFG;            //   0x64  R/W  0x00000000  Functional Bus CFG Block Software Reset Control Register
    volatile unsigned int   NOTDEFINE1[6];          //-  0x68-0x7C      Reserved
    volatile unsigned int   PCLK_TCX;               //   0x80  R/W  0x14000000  Control Register for Timer Counter X Clock
    volatile unsigned int   PCLK_TCT;               //   0x84  R/W  0x14000000  Control Register for Timer Counter T Clock
    volatile unsigned int   PCLK_TCZ;               //   0x88  R/W  0x14000000  Control Register for Timer Counter Z Clock
    volatile unsigned int   PCLK_LCD0;              //   0x8C  R/W  0x14000000  Control Register for LCD Channel 0
    volatile unsigned int   PCLK_LCD1;              //   0x90  R/W  0x14000000  Control Register for LCD Channel 1
    volatile unsigned int   PCLK_LCDSI;             //   0x94  R/W  0x14000000  Control Register for LCD System Interface 0(CPU I/F)
    volatile unsigned int   PCLK_CIFMC;             //   0x98  R/W  0x14000000  Control Register for CIF Internal Camera
    volatile unsigned int   PCLK_CIFSC;             //   0x9C  R/W  0x14000000  Control Register for CIF Scaler Camera
    volatile unsigned int   PCLK_OUT0;              //   0xA0  R/W  0x14000000  Control Register for External Clock Output 0
    volatile unsigned int   PCLK_OUT1;              //   0xA4  R/W  0x14000000  Control Register for External Clock Output 1
    volatile unsigned int   PCLK_HDMI;              //   0xA8  R/W  0x14000000  Control Register for HDMI PHY Input Clock
    volatile unsigned int   PCLK_SDMMC2;            //   0xAC  R/W  0x14000000  Control Register for SD/MMC Channel 2
    volatile unsigned int   PCLK_SDMMC0;            //   0xB0  R/W  0x14000000  Control Register for SD/MMC Channel 0
    volatile unsigned int   PCLK_MSTICK;            //   0xB4  R/W  0x14000000  Control Register for Memory Stick Host Controller
    volatile unsigned int   PCLK_I2C;               //   0xB8  R/W  0x14000000  Control Register for I2C0 External Device Interface
    volatile unsigned int   PCLK_UART0;             //   0xBC  R/W  0x14000000  Control Register for UART Channel 0
    volatile unsigned int   PCLK_UART1;             //   0xC0  R/W  0x14000000  Control Register for UART Channel 1
    volatile unsigned int   PCLK_UART2;             //   0xC4  R/W  0x14000000  Control Register for UART Channel 2
    volatile unsigned int   PCLK_UART3;             //   0xC8  R/W  0x14000000  Control Register for UART Channel 3
    volatile unsigned int   PCLK_UART4;             //   0xCC  R/W  0x14000000  Control Register for UART Channel 4
    volatile unsigned int   PCLK_UART5;             //   0xD0  R/W  0x14000000  Control Register for UART Channel 5
    volatile unsigned int   PCLK_GPSB0;             //   0xD4  R/W  0x14000000  Control Register for GPSB Channel 0
    volatile unsigned int   PCLK_GPSB1;             //   0xD8  R/W  0x14000000  Control Register for GPSB Channel 1
    volatile unsigned int   PCLK_GPSB2;             //   0xDC  R/W  0x14000000  Control Register for GPSB Channel 2
    volatile unsigned int   PCLK_GPSB3;             //   0xE0  R/W  0x14000000  Control Register for GPSB Channel 3
    volatile unsigned int   PCLK_GPSB4;             //   0xE4  R/W  0x14000000  Control Register for GPSB Channel 4
    volatile unsigned int   PCLK_GPSB5;             //   0xE8  R/W  0x14000000  Control Register for GPSB Channel 5
    volatile unsigned int   PCLK_ADC;               //   0xEC  R/W  0x14000000  Control Register for ADC (Touch Screen)
    volatile unsigned int   PCLK_SPDIF;             //   0xF0  R/W  0x14000000  Control Register for SPDIF
    volatile unsigned int   PCLK_EHI0;              //   0xF4  R/W  0x14000000  Control Register for EHI Channel 0
    volatile unsigned int   PCLK_EHI1;              //   0xF8  R/W  0x14000000  Control Register for EHI Channel 1
    volatile unsigned int   PCLK_AUD;               //   0xFC  R/W  0x14000000  Control Register for Audio 0 (7.1ch)
    volatile unsigned int   PCLK_PDM;               //   0x100 R/W  0x14000000  Control Register for PMD/PWM Generator
    volatile unsigned int   PCLK_LCDSI1;            //   0x104 R/W  0x14000000  Control Register for LCD System Interface 1(CPU I/F)
    volatile unsigned int   PCLK_SDMMC1;            //   0x108 R/W  0x14000000  Control Register for SD/MMC Channel 1
    volatile unsigned int   PCLK_I2C1;              //   0x10C R/W  0x14000000  Control Register for I2C1 External Device Interface
    volatile unsigned int   PCLK_AUD1;              //   0x110 R/W  0x14000000  Control Register for Audio 1 (stereo)
    volatile unsigned int   PCLK_I2C2;              //   0x114 R/W  0x14000000  Control Register for I2C2 External Device Interface
    volatile unsigned int   PCLK_ISPS;              //   0x118 R/W  0x14000000  Control Register for ISP System
    volatile unsigned int   PCLK_ISPJ;              //   0x11C R/W  0x14000000  Control Register for ISP JPEG
    volatile unsigned int   PCLK_NFC;               //   0x120 R/W  0x14000000  Control Register for NFC
    volatile unsigned int   PCLK_GMAC;              //   0x124 R/W  0x14000000  Control Register for GMAC
    volatile unsigned int   PCLK_SATA;              //   0x128 R/W  0x14000000  Control Register for SATA
    volatile unsigned int   PCLK_SD3;               //   0x12C R/W  0x14000000  Control Register for SDMMC3
    volatile unsigned int   PCLK_SPDIF1;            //   0x130 R/W  0x14000000  Control Register for SPDIF1
    volatile unsigned int   PCLK_SATA_REF;          //   0x134 R/W  0x14000000  Control Register for SATA Reference
}CKC, *PCKC;

/************************************************************************
*   2. Timer, Counter Register Define             (Base Addr = 0xB0601000) // R/W
************************************************************************/
//#define   HwTMR_BASE                                  *(volatile unsigned long*)0xB0601000
...
/************************************************************************
*   3. Power Management Unit Register Define            (Base Addr = 0xB0503000) // R/W
************************************************************************/
//#define HwPMU_BASE                                  *(volatile unsigned long*)0xB0503000
typedef struct _PMU{
...
/************************************************************************
*   4. SMU I2C Register Define                    (Base Addr = 0xB0605000) // R/W
************************************************************************/
//#define   HwSMUI2C_BASE                               *(volatile unsigned long*)0xB0605000
//#define   HwSMUI2C_MASTER0_BASE                       *(volatile unsigned long*)0xB0605000
//#define   HwSMUI2C_MASTER1_BASE                       *(volatile unsigned long*)0xB0605040
//#define   HwSMUI2C_COMMON_BASE                        *(volatile unsigned long*)0xB0605080
...
/************************************************************************
*   5. RealTime Clock Register Define             (Base Addr = 0xB0502000) // R/W
************************************************************************/
//#define HwRTC_BASE                                  *(volatile unsigned long*)0xB0502000
typedef struct _RTC{
...
/************************************************************************
*   6. SMU Config Register Define                 (Base Addr = 0xB0504000) // R/W
************************************************************************/
//#define HwSMUCONFIG_BASE                            *(volatile unsigned long*)0xB0504000
...
typedef struct _SMUCONFIG{
    ...
    volatile unsigned int cfgPLLFIN_SEL;      //  0x08  R/W  0
    volatile unsigned int cfgRTC_WAIT;        //  0x0C  R/W  0
    volatile unsigned int cfgARM;             //  0x10  R/W  10¡¯b0000100000
...
/*******************************************************************************
*    TCC9300 DataSheet PART 3 GRAPHIC BUS
********************************************************************************/
/************************************************************************
*   X. Overlay Mixer  Register Define             (Base Addr = 0xB0700000) // R/W
************************************************************************/
//#define HwOVERLAYMIXER_BASE                         *(volatile unsigned long*)0xB0700000
...
/************************************************************************
*   4. 2D/3D GPU Register Define              (Base Addr = 0xB0700000) // R/W
************************************************************************/
//#define HwGPU_BASE                                  *(volatile unsigned long*)0xB0700000


/************************************************************************
*   4-3. Pixel Processor Register Define          (Base Addr = 0xB0700000) // R/W
************************************************************************/
//#define HwPIXELPROCESSOR_BASE                      *(volatile unsigned long*)0xB0700000
//#define HwGPU_PXL_FRAMEREGISTERS_BASE              *(volatile unsigned long*)0xB0700000
//#define HwGPU_PXL_WRITEBACKREGISTER_BASE           *(volatile unsigned long*)0xB0700100
//#define HWGPU_PXL_MANAGEMENTREGISTER_BASE          *(volatile unsigned long*)0xB0701000
...
/************************************************************************
*   4-4. Geometry Processor Register Define       (Base Addr = 0xB0702000) // R/W
************************************************************************/
//#define HwGEOMETRYPROCESSOR_BASE                  *(volatile unsigned long*)0xB0702000
//#define HwGPU_GEO_CONTROLREGISTER_BASE              *(volatile unsigned long*)0xB0702000
//#define HwGPU_GEO_PLBCONFIGREGISTER_BASE            *(volatile unsigned long*)0xB0702100
//#define HwGPU_GEO_PLBCONFIGREGISTER_BASE          *(volatile unsigned long*)0xB0700100
//#define HwGPU_GEO_VERTEXSHADER_BASE                 *(volatile unsigned long*)0xB0700000
...
/*************************************************************************
*   4-5. MMU Register Define                      (Base Addr = 0xB0703000) // R/W
************************************************************************/
//#define HwGPUMMUCONFIG_BASE                         *(volatile unsigned long*)0xB0703000
...
/************************************************************************
*   5-1. Graphic Bus Configuration Register Define    (Base Addr = 0xB0704000) // R/W
************************************************************************/
//#define HwGRPBUSCONFIG_BASE                         *(volatile unsigned long*)0xB0704000
...
/************************************************************************
*   5-2. GRPBUS BWRAP Register Define             (Base Addr = 0xB0705000) // R/W
************************************************************************/
//#define HwGRPBUSBWRAP_BASE                          *(volatile unsigned long*)0xB0705000
typedef struct _GRPBUSBWRAP {
    volatile unsigned int   GRPBUS_BWRAPCTRL;            // 0x0000 R/W 0x00000000 Graphics bus bwrap control
}GRPBUSBWRAP, *PGRPBUSBWRAP;
...
/*******************************************************************************
*    TCC9300 DataSheet PART 4 MEMORY BUS
********************************************************************************/
/************************************************************************
*   X. Multi-layer Bus Matrix Register Define     (Base Addr = 0xB0300000) // R/W
************************************************************************/
//#define   HwMULTILAYERBUSMATRIX_BASE                  *(volatile unsigned long*)0xB0300000


/************************************************************************
*   4-2 DDR SDRAM Controller Register Define       (Base Addr = 0xB0301000) // R/W
************************************************************************/
//#define HwLPDDR_BASE                                *(volatile unsigned long*)0xB0301000
//#define HwDDR2_BASE                                 *(volatile unsigned long*)0xB0302000
//#define HwLPDDRCFG_BASE                             *(volatile unsigned long*)0xB0303000
//#define HwDDR3_BASE                                 *(volatile unsigned long*)0xB030C000
//#define HwDDRIFCFG_BASE                             *(volatile unsigned lohg*)0xB0303000
//#define HwDDRIFCFG_BASE                             *(volatile unsigned lohg*)0xB0304000
//#define HwDDR3PHY_BASE                              *(volatile unsigned long*)0xB0304400
//#define HwLPDDR2_BASE                               *(volatile unsigned long*)0xB0305000
...
typedef struct _DRAMMISC{
    ...
    volatile unsigned int   NOTDEFINE3[3];  //0x38 - 0x40          Reserved
    volatile unsigned int   M3CFG0;         //0x44      0x00000000 DDR2/DDR3 SDRAM Controller Configuration Register
}DRAMMISC, *PDRAMMISC, DRAMIFCFG, *PDRAMIFCFG, DMCCFG, *PDMCCFG;


//#define   HwDRAMM2_BASE                           *(volatile unsigned long *)0xB0305000   //
...
//#define   HwDRAMM3_BASE                           *(volatile unsigned long *)0xB030C000   //
...
/************************************************************************
*   5. Static Memory Controller Register Define   (Base Addr = 0xB0306000) // R/W
************************************************************************/
//#define HwSMC_BASE                                  *(volatile unsigned long*)0xB0306000
typedef struct _SMC{
...
/************************************************************************
*   6. External Device Interface Register Define  (Base Addr = 0xB0308000) // R/W
************************************************************************/
//#define HwEDI_BASE                                  *(volatile unsigned long*)0xB0308000
typedef struct _EDI{
...
/************************************************************************
*   8. Memory Bus Configuration Register Define   (Base Addr = 0xB030B000) // R/W
************************************************************************/
//#define HwMEMBUSCFG_BASE                            *(volatile unsigned long*)0xB030B000
typedef struct _DRAMMEMBUS{
    volatile unsigned int   HCLKMASK;           // 0x00  R/W  0x00000000  Module Clock Mask Register
    volatile unsigned int   SWRESET0;           // 0x04  R/W  0x00543210  Memory Bus Soft Reset Register
    volatile unsigned int   BM0;                // 0x08  R/W  0x00BA9876  Multi-layer Bus Matrix Configuration Register
    volatile unsigned int   REGSLICE;           // 0x0C  R/W  0x00000004  Memrory Bus Slow Bus Configuration Register
    volatile unsigned int   _NOTDEFINE0[4];
    volatile unsigned int   PB0EN;              // 0x20  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Enable Register
    volatile unsigned int   PB0A0MIN;           // 0x24  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 0 MIN Register
    volatile unsigned int   PB0A0MAX;           // 0x28  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 0 MAX Register
    volatile unsigned int   PB0A1MIN;           // 0x2C  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 1 MIN Register
    volatile unsigned int   PB0A1MAX;           // 0x30  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 1 MAX Register
    volatile unsigned int   PB0A2MIN;           // 0x34  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 2 MIN Register
    volatile unsigned int   PB0A2MAX;           // 0x38  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 2 MAX Register
    volatile unsigned int   PB0A3MIN;           // 0x3C  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 3 MIN Register
    volatile unsigned int   PB0A3MAX;           // 0x40  R/W  0x00000000  Prefetch Buffer 0 (ARM Data) Address 3 MAX Register
    volatile unsigned int   PB1EN;              // 0x44  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Enable Register
    volatile unsigned int   PB1A0MIN;           // 0x48  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Address 0 MIN Register
    volatile unsigned int   PB1A0MAX;           // 0x4C  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Address 0 MAX Register
    volatile unsigned int   PB1A1MIN;           // 0x50  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Address 1 MIN Register
    volatile unsigned int   PB1A1MAX;           // 0x54  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Address 1 MAX Register
    volatile unsigned int   PB1A2MIN;           // 0x58  R/W  0x00000000  Prefetch Buffer 1 (IO Bus ta) Address 2 MIN Register
    volatile unsigned int   PB1A2MAX;           // 0x5C  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Address 2 MAX Register
    volatile unsigned int   PB1A3MIN;           // 0x60  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Address 3 MIN Register
    volatile unsigned int   PB1A3MAX;           // 0x64  R/W  0x00000000  Prefetch Buffer 1 (IO Bus) Address 3 MAX Register
    volatile unsigned int   PB2EN;              // 0x68  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Enable Register
    volatile unsigned int   PB2A0MIN;           // 0x6C  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Address 0 MIN Register
    volatile unsigned int   PB2A0MAX;           // 0x70  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Address 0 MAX Register
    volatile unsigned int   PB2A1MIN;           // 0x74  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Address 1 MIN Register
    volatile unsigned int   PB2A1MAX;           // 0x78  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Address 1 MAX Register
    volatile unsigned int   PB2A2MIN;           // 0x7C  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus ta) Address 2 MIN Register
    volatile unsigned int   PB2A2MAX;           // 0x80  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Address 2 MAX Register
    volatile unsigned int   PB2A3MIN;           // 0x84  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Address 3 MIN Register
    volatile unsigned int   PB2A3MAX;           // 0x88  R/W  0x00000000  Prefetch Buffer 2 (HSIO Bus) Address 3 MAX Register
}DRAMMEMBUS, *PDRAMMEMBUS;

/************************************************************************
*   9. Internal Memory Bus Configuration Register Define  (Base Addr = 0xB0307000) // R/W
************************************************************************/
//#define HwINTNLMEMBUSCFG_BASE                       *(volatile unsigned long*)0xB0307000
typedef struct _IMCCFG{
    ...
    volatile unsigned int   _NOTDEFINE0[2];     //
    volatile unsigned int   RDWCFG;             // 0x28  R/W  0x11 Memory RDW Configuration Register
    volatile unsigned int   IRAMPWRCFG;         // 0x2C  R/W  0x0  Internal ROM Power Down Register
}VMTREGION, *PVMTREGION, IMCCFG, *PIMCCFG;




/*******************************************************************************
*    TCC9300 DataSheet PART 5 IO BUS
********************************************************************************/
/************************************************************************
*   4. SD/SDIO/MMC Register Define                (Base Addr = 0xB0020000) // R/W
************************************************************************/
//#define HwSDMMC_BASE                                *(volatile unsigned long*)0xB0020000
//#define HwSDMMC0_BASE                               *(volatile unsigned long*)0xB0020000
//#define HwSDMMC1_BASE                               *(volatile unsigned long*)0xB0020200
//#define HwSDMMC2_BASE                               *(volatile unsigned long*)0xB0020400
//#define HwSDMMC3_BASE                               *(volatile unsigned long*)0xB0020600
//#define HwSDMMC_CHCTRL_BASE                         *(volatile unsigned long*)0xB0020800
...
/************************************************************************
*   5. External Host Interface Register Define    (Base Addr = 0xB0010000) // R/W
*************************************************************************/
// If HPCSN is 0
//#define HwEHI_HPCSN0_BASE                                  *(volatile unsigned long*)0xB0000000
// if HPCSN is 1
//#define HwEHI_HPCSN1_BASE                                  *(volatile unsigned long*)0xB0010000
...
/************************************************************************
*   6. DMA Controller Register Define             (Base Addr = 0xB0030000) // R/W
************************************************************************/
//#define HwGDMA_BASE                                 *(volatile unsigned long*)0xB0030000
//#define HwGDMA0_BASE                                *(volatile unsigned long*)0xB0030000
//#define HwGDMA1_BASE                                *(volatile unsigned long*)0xB0030100
//#define HwGDMA2_BASE                                *(volatile unsigned long*)0xB0030200
//#define HwGDMA3_BASE                                *(volatile unsigned long*)0xB0030300
...
typedef struct _GPIO{
    ...
    volatile unsigned int   GPGCD0;                 //   0x194  W  0x55555555  Driver strength Control 0 on GPG Output Data
    volatile unsigned int   GPGCD1;                 //   0x198  W  0x00000000  Driver strength Control 1 on GPG Output Data
    volatile unsigned int   GPGPD0;                 //   0x19C  W  0x55555555  Pull-Up/Down function on GPG Output Data
    volatile unsigned int   GPGPD1;                 //   0x1A0  W  0x00000000  Pull-Up/Down function on GPG Output Data
    volatile unsigned int   GPGFN0;                 //   0x1A4  W  0x00000000  Port Configuration on GPG Output Data
    volatile unsigned int   GPGFN1;                 //   0x1A8  W  0x00000000  Port Configuration on GPG Output Data
    volatile unsigned int   GPGFN2;                 //   0x1AC  W  0x00000000  Port Configuration on GPG Output Data
    volatile unsigned int   GPGFN3;                 //   0x1B0  W  0x00000000  Port Configuration on GPG Output Data
    volatile unsigned int   GPGIEN;                 //   0x1B4  R/W  0x00000000 GPG Input Enable Register
    volatile unsigned int   GPGIS;                  //   0x1B8  R/W  0x00000000 GPG Input Type Selection Register
    volatile unsigned int   GPGSR;                  //   0x1BC  R/W  0x00000000 GPG Slew rate Control Register
    volatile unsigned int   NOTDEFINE0[17];         //   0x1C0~0x200     Reserved
    volatile unsigned int   EINTSEL0;               //   0x204  R/W  0x00000000  External Interrupt Select Register 01
    volatile unsigned int   EINTSEL1;               //   0x208  R/W  0x00000000  External Interrupt Select Register 1
    volatile unsigned int   NOTDEFINE1;             //   0x20C   Reserved
    volatile unsigned int   EINTSEL2;               //   0x210  R/W  0x00000000  External Interrupt Select Register 2
    //volatile unsigned int   EINTSEL3;               //   0x214  R/W  0x00000000  External Interrupt Select Register 3
    
	volatile unsigned int	ECID0;					//	 0x214	R/W 0x00000000	CID Output Register
	volatile unsigned int	ECID1;					//	 0x218	R/W 	-		CID Serial Input Register
	volatile unsigned int	ECID2;					//	 0x21C	R/W 	-		CID Parallel Input 0 Register
	volatile unsigned int	ECID3;					//	 0x220	R/W 	-		CID Parallel Input 1 Register
...
// for tcc93 tsc2003 by kch
typedef struct _GPIOINT{
//	volatile unsigned int	NOTDEFINED0;			// 0x204  R/W	Not Used // by kch
	volatile unsigned int	EINTSEL0;				// 0x204  R/W	External Interrupt Select Register 0
	volatile unsigned int	EINTSEL1;				// 0x208  R/W	External Interrupt Select Register 1 
	volatile unsigned int	EINTSEL2;				// 0x20C  R/W	External Interrupt Select Register 2 
	volatile unsigned int	EINTSEL3;				// 0x20C  R/W	External Interrupt Select Register 3 
} GPIOINT, *PGPIOINT;

/************************************************************************
*   8. GPSB Controller Register Define           (Base Addr = 0xB0107000) // R/W
************************************************************************
#define HwGPSB_BASE                                 *(volatile unsigned long*)0xB0107000
#define HwGPSB0_BASE                                *(volatile unsigned long*)0xB0107000
#define HwGPSB1_BASE                                *(volatile unsigned long*)0xB0107100
#define HwGPSB2_BASE                                *(volatile unsigned long*)0xB0107200
#define HwGPSB3_BASE                                *(volatile unsigned long*)0xB0107300
#define HwGPSB4_BASE                                *(volatile unsigned long*)0xB0107400
#define HwGPSB5_BASE                                *(volatile unsigned long*)0xB0107500

#define HwGPSBPRTCFG_BASE                           *(volatile unsigned long*)0xB0107800
#define HwGPSBPIDTBL_BASE                           *(volatile unsigned long*)0xB0107F00 */
...
/************************************************************************
*   9. 2D Graphic Controller Register Define      (Base Addr = 0xB0070000) // R/W
************************************************************************/
//#define HwOVERLAYMIXER_BASE                         *(volatile unsigned long*)0xB0070000
...
/************************************************************************
*   10, 11. Audio DMA Controller Register Define      (Base Addr = 0xB0103000) // R/W
************************************************************************/
/*******************************************************************************
*   10-1. Audio DMA Controller Register 7.1 ch Define   (Base Addr = 0xB0103000)
********************************************************************************/
//#define HwADMA0_BASE                                 *(volatile unsigned long*)0xB0103000
...
/*******************************************************************************
*   10-2. Audio DMA DAI Register 7.1 ch Define          (Base Addr = 0xB0104000)
********************************************************************************/
//#define HwDAI0_BASE                                  *(volatile unsigned long*)0xB0104000
...
/*******************************************************************************
*   10-3. Audio DMA CDIF Register 7.1 ch Define   (Base Addr = 0xB0104080)
********************************************************************************/
//#define HwCDIF0_BASE                                 *(volatile unsigned long*)0xB0104080
...
/*******************************************************************************
*   10-4/10-5. ADMA_SPDIF Tx/Rx Register 7.1 ch Define   (Base Addr = 0xB010B000/0xB010B800)
********************************************************************************/
//#define HwSPDIF0TX_BASE                              *(volatile unsigned long*)0xB010B000
//#define HwSPDIF0RX_BASE                              *(volatile unsigned long*)0xB010B800
...
********************************************************************************/
/*******************************************************************************
*   11-1. Audio DMA Register Stereo Define              (Base Addr = 0xB0105000)
********************************************************************************/
//#define HwADMA1_BASE                                *(volatile unsigned long*)0xB0105000
typedef struct _STREREOADMA{
    volatile unsigned int   RxDaDar;            // 0x00 R/W 0x00000000  DAI Rx (Right) Data Destination Address
    volatile unsigned int   RxDaParam;          // 0x04 R/W 0x00000000  DAI Rx Parameters
    volatile unsigned int   RxDaTCnt;           // 0x08 R/W 0x00000000  DAI Rx Transmission Counter Register
    volatile unsigned int   RxDaCdar;           // 0x0C R   0x00000000  DAI Rx (Right) Data Current Destination Address
    volatile unsigned int   RxCdDar;            // 0x10 R/W 0x00000000  CDIF Rx (Right) Data Destination Address
    volatile unsigned int   RxCdParam;          // 0x14 R/W 0x00000000  CDIF Rx Parameters
    volatile unsigned int   RxCdTCnt;           // 0x18 R/W 0x00000000  CDIF Rx Transmission Counter Register
    volatile unsigned int   RxCdCdar;           // 0x1C R   0x00000000  CDIF Rx (Right) Data Current Destination Address
    volatile unsigned int   NOTDEFINE0[2];      // 0x20, 0x24   Reserved
    volatile unsigned int   RxDaDarL;           // 0x28 R/W 0x00000000  DAI Rx Left Data Destination Address
    volatile unsigned int   RxDaCdarL;          // 0x2C R   0x00000000  DAI Rx Left Data Current Destination Address
    volatile unsigned int   RxCdDarL;           // 0x30 R/W 0x00000000  CDIF Rx Left Data Destination Address
    volatile unsigned int   RxCdCdarL;          // 0x34     R   0x00000000  CDIF Rx Left Data Current Destination Address
    volatile unsigned int   TransCtrl;          // 0x38 R/W 0x0000AA00  DMA Transfer Control Register
    volatile unsigned int   RptCtrl;            // 0x3C R/W 0x00000000  DMA Repeat Control Register
    volatile unsigned int   TxDaSar;            // 0x40 R/W 0x00000000  DAI Tx (Right) Data Source Address
    volatile unsigned int   TxDaParam;          // 0x44 R/W 0x00000000  DAI Tx Parameters
    ...
    volatile unsigned int   TxSpTCnt;           // 0x58 R/W 0x00000000  SPDIF Tx Transmission Counter Register
    volatile unsigned int   TxSpCsar;           // 0x5C R   0x00000000  SPDIF Tx (Right) Data Current Source Address
    volatile unsigned int   NOTDEFINE1[2];      // 0x60, 0x64   Reserved
    volatile unsigned int   TxDaSarL;           // 0x68 R/W 0x00000000  DAI Tx Left Data Source Address
    volatile unsigned int   TxDaCsarL;          // 0x6C     R   0x00000000  DAI Tx Left Data Current Source Address
    volatile unsigned int   TxSpSarL;           // 0x70 R/W 0x00000000  SPDIF Tx Left Data Source Address
    volatile unsigned int   TxSpCsarL;          // 0x74 R   0x00000000  SPDIF Tx Left Data Current Source address
    volatile unsigned int   ChCtrl;             // 0x78 R/W 0x00008000  DMA Channel Control Register
    volatile unsigned int   IntStatus;          // 0x7C R/W 0x00000000  DMA Interrupt Status Register
}STREREOADMA, *PSTREREOADMA;

/*******************************************************************************
*   11-2. Audio DAI Register Stereo Define              (Base Addr = 0xB0106000)
********************************************************************************/
//#define HwDAI1_BASE                                 *(volatile unsigned long*)0xB0106000
...
/*******************************************************************************
*    11-3. Audio DMA CDIF Register Stereo Define        (Base Addr = 0xB0106000)
********************************************************************************/
//#define HwCDIF1_BASE                                *(volatile unsigned long*)0xB0106080
...
/*******************************************************************************
*    11-4. Aduio DMA SPDIF Tx Register Stereo Define    (Base Addr = 0xB010D000)
********************************************************************************/
//#define HwSPDIF1TX_BASE                             *(volatile unsigned long*)0xB010D000*/
...
/************************************************************************
*   12. NAND Flash Controller Register Define      (Base Addr = 0xB0050000) // R/W
************************************************************************/
/*
#define HwNFC_BASE                                  *(volatile unsigned long*)0xB0050000
#define HwNFCDMA_BASE                               *(volatile unsigned long*)0xB0050100
#define HwNFCSUBPAGE_BASE                           *(volatile unsigned long*)0xB0050120
#define HwNFCECC_BASE                               *(volatile unsigned long*)0xB0050200
#define HwNFCECCERR_BASE                            *(volatile unsigned long*)0xB0050260
#define HwNFCMEMORY_BASE                            *(volatile unsigned long*)0xB0050400
*/
...
/************************************************************************
*   13. USB2.0 OTG Controller 0 Register Define      (Base Addr = 0xB0040000) // R/W
************************************************************************/
//#define HwUSBOTG0_BASE                               *(volatile unsigned long*)0xB0040000

/************************************************************************
*   1. USB2.0 OTG Controller 1 Register Define      (Base Addr = 0xB0800000) // R/W
*************************************************************************/
//#define HwUSBOTG0_BASE                               *(volatile unsigned long*)0xB0040000
//#define HwUSBOTG1_BASE                               *(volatile unsigned long*)0xB0800000
// Peripheral Bus CFG
//#define HwUSBOTG0CFG_BASE                            *(volatile unsigned long*)0xB0080020
//#define HwUSBPHY0CFG_BASE                            *(volatile unsigned long*)0xB0080024
//#define HwUSBOTG1CFG_BASE                            *(volatile unsigned long*)0xB0880020
//#define HwUSBPHY1CFG_BASE                            *(volatile unsigned long*)0xB0880024
...
/************************************************************************
*   14. I2C Controller Register Define            (Base Addr = 0xB0109000) // R/W
************************************************************************/
/*
#define HwI2C_BASE                                  *(volatile unsigned long*)0xB0109000
#define HwI2C0_BASE                                 *(volatile unsigned long*)0xB0109000
#define HwI2C1_BASE                                 *(volatile unsigned long*)0xB0109100
#define HwI2C2_BASE                                 *(volatile unsigned long*)0xB0109200

#define HwI2CIRQ_BASE                               *(volatile unsigned long*)0xB0109300
#define HwI2CDREQSEL_BASE                           *(volatile unsigned long*)0xB0109400
*/
...
/************************************************************************
*   15. Pulse Density Modulation(PDM, PWM) Register Define   (Base Addr = 0xB0060000) // R/W
************************************************************************/
//#define HwPDM_BASE                                  *(volatile unsigned long*)0xB0060000
...
/************************************************************************
*   16. Remote Control Register Define            (Base Addr = 0xB0101000) // R/W
************************************************************************/
//#define HwREMOTE_BASE                               *(volatile unsigned long*)0xB0101000
...
/************************************************************************
*   17. TSADC Controller Register Define           (Base Addr = 0xB0100000) // R/W
************************************************************************/
//#define HwTSADC_BASE                                *(volatile unsigned long*)0xB0100000
...
/************************************************************************
*   18. TS Interface Register Define              (Base Addr = 0xB0108000) // R/W
************************************************************************/
//#define HwTSIF_BASE                                 *(volatile unsigned long*)0xB0108000
//#define HwTSIF0_BASE                                *(volatile unsigned long*)0xB0108000
//#define HwTSIF1_BASE                                *(volatile unsigned long*)0xB0108100
...
/************************************************************************
*   19. UART Controller Register Define           (Base Addr = 0xB0102000) // R/W
************************************************************************/
/*
#define HwUART_BASE                                 *(volatile unsigned long*)0xB0102000
#define HwUARTCH0_BASE                              *(volatile unsigned long*)0xB0102100
#define HwUARTCH1_BASE                              *(volatile unsigned long*)0xB0102100
#define HwUARTCH2_BASE                              *(volatile unsigned long*)0xB0102200
#define HwUARTCH3_BASE                              *(volatile unsigned long*)0xB0102300
#define HwUARTCH4_BASE                              *(volatile unsigned long*)0xB0102400
#define HwUARTCH5_BASE                              *(volatile unsigned long*)0xB0102500
#define HwUARTPORTMUX_BASE                          *(volatile unsigned long*)0xB0102600
*/
...
/************************************************************************
*   20. Vectored Priority Interrupt Controller Register Define (Base Addr = 0xB0600000) // R/W
************************************************************************/
//#define HwVPIC_BASE                                 *(volatile unsigned long*)0xB0600000
//#define HwPRIOINTRCTR_BASE                          *(volatile unsigned long*)0xB0600000
//#define HwVECTINTRCTR_BASE                          *(volatile unsigned long*)0xB0600200
...
/************************************************************************
*   21. IO BUS Configuration Register Define      (Base Addr = 0xB0800000) // R/W
************************************************************************/
//#define HwIOBUSCFG_BASE                             *(volatile unsigned long*)0xB0800000
//#define HwIOBUSCFG_BASE                             *(volatile unsigned long*)0xB0080000

typedef struct _IOBUSCFG{
    volatile unsigned int   HCLKMASK0;          //  0x00    Module Clock Mask Register 0
    volatile unsigned int   SWRESET0;           //  0x04    Module Software Reset Register 0
    volatile unsigned int   HCLKMASK1;          //  0x08    Module Clock Mask Register 1
    volatile unsigned int   SWRESET1;           //  0x0C    Module Software Reset Register 1
    volatile unsigned int   NOTDEFINE[2];       //  0x10, 0x14
    volatile unsigned int   WAITCTRL;           //  0x18    IOBUS APB wait counter Register
    volatile unsigned int   NFCACK_SEL;         //  0x1C
    volatile unsigned int   USBOTG;             //  0x20    Refer to USB OTG Configuration Register (OTGCR) in  ¡°13.2  Register Description for USB 2.0 OTG Controller¡±USB OTG Configuration Register (OTGCR)USB OTG Configuration Register (OTGCR)USB OTG Configuration Register (OTGCR)USB OTG Configuration Register (OTGCR)USB OTG Configuration Register (OTGCR).
    volatile unsigned int   USBOTG0;            //  0x24    Refer to USB PHY Configuration Register0 (UPCR0) in ¡°13.2  Register Description for USB 2.0 OTG Controller¡±
    volatile unsigned int   USBOTG1;            //  0x28    Refer to USB PHY Configuration Register1 (UPCR1) in ¡°13.2  Register Description for USB 2.0 OTG Controller¡±
    volatile unsigned int   USBOTG2;            //  0x2C    Refer to USB PHY Configuration Register3 (UPCR3) in ¡°13.2  Register Description for USB 2.0 OTG Controller¡±
    volatile unsigned int   USBOTG3;            //  0x30    Refer to USB PHY Configuration Register3 (UPCR3) in ¡°13.2  Register Description for USB 2.0 OTG Controller
    volatile unsigned int   NOTDEFINE1[3];      //  0x34~0x3C
    volatile unsigned int   IO_A2X;             //  0x40    IOBUS AHB2AXI Control Register
    volatile unsigned int   MEM_EMA;            //  0x44    IOBUS Memory EMA Configuration Register
}IOBUSCFG, *PIOBUSCFG;



/*******************************************************************************
*    TCC9300 DataSheet PART 6 HSIO BUS
********************************************************************************/
/************************************************************************
*   4. USB2.0 OTG Controller 1 Register Define      (Base Addr = 0xB0800000) // R/W
*************************************************************************/
//#define HwUSBOTG1_BASE                               *(volatile unsigned long*)0xB0800000
...
/************************************************************************
*   5. Memory Stick Controller Register Define      (Base Addr = 0xB0840000) // R/W
*************************************************************************/
//#define HwMSTICK_BASE                               *(volatile unsigned long*)0xB0840000
//#define HwMSTICKCFG_BASE                            *(volatile unsigned long*)0xB0870100
...
/************************************************************************
*   SATA Controller Register Define              (Base Addr = 0xB0810000) // R/W
*************************************************************************/
/*******************************************************************************
*   6. SATA Host                                        (Base Addr =  0xB0810000)
********************************************************************************/
...
/*******************************************************************************
*   7. SATA Device                                      (Base Addr = )
********************************************************************************/
/*******************************************************************************
*   8. SATA PHY                                         (Base Addr = )
********************************************************************************/
/*
#define HwSATA_BASE                                  *(volatile unsigned long*)0xB0810000
#define HwSATAHOST_BASE                              *(volatile unsigned long*)0xB0810000
#define HwSATADEVICE_BASE                            *(volatile unsigned long*)0xB0850000
#define HwSATAPHY_BASE                               *(volatile unsigned long*)0xB0860000
#define HwSTATPHYCMU_BASE                            *(volatile unsigned long*)0xB0860000
#define HwSTATPHYLANE_BASE                           *(volatile unsigned long*)0xB0860200
#define HwSTATPHYCLANE_BASE                          *(volatile unsigned long*)0xB0860A00
*/

/************************************************************************
*   9. Ethernet MAC Controller Register Define      (Base Addr = 0xB0820000) // R/W
*************************************************************************/
/*
#define HwGMAC_BASE                                 *(volatile unsigned long*)0xB0820000
#define HwGMACTIMESTAMP_BASE                        *(volatile unsigned long*)0xB0820700
#define HwGMACADDR_BASE                             *(volatile unsigned long*)0xB0820800
#define HwGMACDMA_BASE                              *(volatile unsigned long*)0xB0821000
*/
...
/************************************************************************
*   10. Cipher Controller Register Define            (Base Addr = 0xB0870000) // R/W
*************************************************************************/
//#define HwCIPHER_BASE                               *(volatile unsigned long*)0xB0870000
...
/************************************************************************
*   11. HSIO Bus Configuration Register Define       (Base Addr = 0xB0880000) // R/W
*************************************************************************/
//#define HwHSIOBUSMATRIX_BASE                        *(volatile unsigned long*)0xB0870200
//#define HwHSIOBUSCFG_BASE                           *(volatile unsigned long*)0xB0880000

typedef struct _HSIOBUSCFG{
    volatile unsigned int HCLKMASK0/*SLEEP0*/;     // 0x00              Module Clock Mask Register 0
    volatile unsigned int SWRESET0;                // 0x04              Module Software Reset Register 0
    volatile unsigned int MEM_PDN;                 // 0x08
    volatile unsigned int MEM_SLN;                 // 0x0C
    volatile unsigned int USBOTG;                  // 0x10              Refer to  USB OTG Configuration Register  (OTGCR) in ¡°4.2 Register Description for USB 2.0 OTG Controller¡±
    volatile unsigned int USBOTG_CFG0;             // 0x14              Refer to  USB PHY Configuration Register0 (UPCR0) in ¡°4.2 Register Description for USB 2.0 OTG Controller¡±
    volatile unsigned int USBOTG_CFG1;             // 0x18              Refer to  USB PHY Configuration Register1 (UPCR1) in ¡°4.2 Register Description for USB 2.0 OTG Controller¡±
    volatile unsigned int USBOTG_CFG2;             // 0x1C              Refer to  USB PHY Configuration Register3 (UPCR3) in ¡°4.2 Register Description for USB 2.0 OTG Controller¡±
    volatile unsigned int USBOTG_CFG3;             // 0x20              Refer to  USB PHY Configuration Register3 (UPCR3) in ¡°4.2 Register Description for USB 2.0 OTG Controller
    volatile unsigned int _NOTDEFINED0[3];         //
    volatile unsigned int ETHER_CFG;               // 0x30
    volatile unsigned int _NOTDEFINED1[3];         //
    volatile unsigned int SATA_MCTRL;              // 0x40 0x0000_0040  SATA Mux Control Register
    volatile unsigned int SATA_PCTRL;              // 0x44 0x0000_0000  SATA PHY Control Register
    volatile unsigned int SATA_LCTRL;              // 0x48 0x0000_000A  SATA Link Control Register
    volatile unsigned int SATA_PSTS;               // 0x4C 0x0000_0000  SATA PHY Status Register
    volatile unsigned int SATA_LSTS;               // 0x50 0x0000_0000  SATA Link Status Register
    volatile unsigned int HSIO_A2X;                // 0x54              HSIOBUS AHB2AXI Control Register
    volatile unsigned int HSIO_MEM_EMA;            // 0x58
}HSIOBUSCFG, *PHSIOBUSCFG;



/*******************************************************************************
*    TCC9300 DataSheet PART 7 DISPLAY Bus
********************************************************************************/
/************************************************************************
*   4. LCD Controller Register Define               (Base Addr = 0xB0A00000) // R/W
*************************************************************************/
//#define HwLCDC_BASE                                 *(volatile unsigned long*)0xB0A00000
//#define HwLCDC0_BASE                                *(volatile unsigned long*)0xB0A00000
//#define HwLCDC1_BASE                                *(volatile unsigned long*)0xB0A04000
//#define HwLCDLUT0_BASE                              *(volatile unsigned long*)0xB0A00400
//#define HwLCDLUT1_BASE                              *(volatile unsigned long*)0xB0A04400
...
/************************************************************************
*   5. LCD System Interface Register Define         (Base Addr = 0xB0A08000) // R/W
*************************************************************************/
//#define HwLCDSI_BASE                                *(volatile unsigned long*)0xB0A08000
//#define HwLCDSI0_BASE                               *(volatile unsigned long*)0xB0A08000
//#define HwLCDSI1_BASE                               *(volatile unsigned long*)0xB0A0C000
...
/************************************************************************
*   6. Memory to Memory Scaler Register Define      (Base Addr = 0xB0A10000) // R/W
*************************************************************************/
//#define HwM2MSCALER_BASE                            *(volatile unsigned long*)0xB0A10000
//#define HwM2MSCASER0_BASE                           *(volatile unsigned long*)0xB0A10000
//#define HwM2MSCASER1_BASE                           *(volatile unsigned long*)0xB0A20000

//#define HwSCALERPOSTFILTER_BASE                     *(volatile unsigned long*)0xB0A5B000
...
/************************************************************************
*   7. TV Encoder Controller Register Define        (Base Addr = 0xB0A40000) // R/W
*************************************************************************/
//#define HwTVENCODER_BASE                            *(volatile unsigned long*)0xB0A40000
...
/************************************************************************
*   8. HDMI Controller Register Define              (Base Addr = 0xB0A54000) // R/W
*************************************************************************/
//#define HwHDMI_BASE                                 *(volatile unsigned long*)0xB0A54000
//#define HwHDMICTRL_BASE                             *(volatile unsigned long*)0xB0A54000
//#define HwHDMICORE_BASE                             *(volatile unsigned long*)0xB0A55000
//#define HwHDMIAES_BASE                              *(volatile unsigned long*)0xB0A56000
//#define HwHDMISPDIF_BASE                            *(volatile unsigned long*)0xB0A57000
//#define HwHDMII2S_BASE                              *(volatile unsigned long*)0xB0A58000
//#define HwHDMICEC_BASE                              *(volatile unsigned long*)0xB0A59000
...
/************************************************************************
*   9. Video and Image Enhancer Register Define     (Base Addr = 0xB0A52000) // R/W
*************************************************************************/
//#define HwVIQE_BASE                                 *(volatile unsigned long*)0xB0A52000
//#define HwVIQELUT_BASE                              *(volatile unsigned long*)0xB0A53000
...
/************************************************************************
*   10. DDI Configuration Register Define            (Base Addr = 0xB0A51000) // R/W
*************************************************************************/
//#define HwDDICFG_BASE                               *(volatile unsigned long*)0xB0A51000
...
/************************************************************************
*   11. DDI Cache Register Define                    (Base Addr = 0xB0A50000) // R/W
*************************************************************************/
//#define HwDDICACHE_BASE                             *(volatile unsigned long*)0xB0A50000
...
/*******************************************************************************
*    TCC9300 DataSheet PART 8 Video Bus
********************************************************************************/
/*******************************************************************************
*   4 JPEG Encoder  Register Define                     (Base Addr = 0xB0980000)
********************************************************************************/
//#define HwJPEGENC_BASE                              *(volatile unsigned long*)0xB0980000
...
/*******************************************************************************
*   5 Video Codec Register Define                       (Base Addr = 0xB0910000)
********************************************************************************/
//#define HwVIDEOCODEC_BASE                           *(volatile unsigned long*)0xB0900000


/*******************************************************************************
*   6 Video Cache Register Define                       (Base Addr = 0xB0910000)
********************************************************************************/
//#define HwVIDEOCACHE_BASE                           *(volatile unsigned long*)0xB0910000
...
/*******************************************************************************
*   7 Video Bus Configuration Register Define           (Base Addr = 0xB0920000)
********************************************************************************/
//#define HwVIDEOBUSCFG_BASE                          *(volatile unsigned long*)0xB0920000
...
/*******************************************************************************
*    TCC9300 DataSheet PART 9 Camera Bus
********************************************************************************/
/************************************************************************
*   4. Camera Interface Register Define             (Base Addr = 0xB0200000) // R/W
*************************************************************************/
//#define HwCIF_BASE                                  *(volatile unsigned long*)0xB0200000
//#define HwCIFEFFECTOR_BASE                          *(volatile unsigned long*)0xB0200100
//#define HwCIFSCALER_BASE                            *(volatile unsigned long*)0xB0200200
...
*/  volatile unsigned int   NOTDEFINE1[1];      //  0x40    W/R     0x00000000  Reserved
...
/************************************************************************
*   5. ISP Register Define                          (Base Addr = 0xB0210000) // R/W
*************************************************************************/
/*
#define HwISP_BASE                                  *(volatile unsigned long*)0xB0210000
#define HwISPIMGEFF_BASE                            *(volatile unsigned long*)0xB0210200
#define HwISPSI_BASE                                *(volatile unsigned long*)0xB0210300
#define HwISPMAIN_BASE                              *(volatile unsigned long*)0xB0210400
#define HwISPFLASH_BASE                             *(volatile unsigned long*)0xB0210660
#define HwISPSHUT_BASE                              *(volatile unsigned long*)0xB0210680
#define HwISPCPROC_BASE                             *(volatile unsigned long*)0xB0210800
#define HwISPMRSZ_BASE                              *(volatile unsigned long*)0xB0210C00
#define HwISPSRSZ_BASE                              *(volatile unsigned long*)0xB0211000
#define HwISPMI_BASE                                *(volatile unsigned long*)0xB0211400
#define HwISPJPE_BASE                               *(volatile unsigned long*)0xB0211800
#define HwISPSMIA_BASE                              *(volatile unsigned long*)0xB0211A00
#define HwISPMIPI_BASE                              *(volatile unsigned long*)0xB0211C00
#define HwISPAFM_BASE                               *(volatile unsigned long*)0xB0212000
#define HwISPBP_BASE                                *(volatile unsigned long*)0xB0212100
#define HwISPLSC_BASE                               *(volatile unsigned long*)0xB0212200
#define HwISPIS_BASE                                *(volatile unsigned long*)0xB0212300
#define HwISPHIST_BASE                              *(volatile unsigned long*)0xB0212400
#define HwISPFILT_BASE                              *(volatile unsigned long*)0xB0212500
#define HwISPCAC_BASE                               *(volatile unsigned long*)0xB0212580
#define HwISPAE_BASE                                *(volatile unsigned long*)0xB0212600
#define HwISPBLS_BASE                               *(volatile unsigned long*)0xB0212700
#define HwISPDPF_BASE                               *(volatile unsigned long*)0xB0212800
#define HwISPDPCC_BASE                              *(volatile unsigned long*)0xB0212900
#define HwISPWDR_BASE                               *(volatile unsigned long*)0xB0212A00
*/

/************************************************************************
*   6. CAMBUS Configuration Register Define                          (Base Addr = 0xB0230000) // R/W
*************************************************************************/
//#define HwCAMBUSCFG_BASE                            *(volatile unsigned long*)0xB0213000
...
/*******************************************************************************
*    TCC9300 DataSheet PART 10 DISPLAY Sub Bus
********************************************************************************/
/*************************************************************************
*   4. MIPI Register Define     (Base Addr = 0xB0230000) // R/W
*************************************************************************/
//#define HwMIPI_BASE                                 *(volatile unsigned long*)0xB0B10000
//#define HwMIPIDSBUSCFG_BASE                         *(volatile unsigned long*)0xB0B11000
...
/*******************************************************************************
*   5 Display Sub Bus Configuration Register Map                (Base Address = 0xB0B11000)
********************************************************************************/
typedef struct _MIPIDSBUSCFG{
    volatile unsigned int   HCLKMASK;              //  0x00  R/W       0x00000000    HCLK mask register
    volatile unsigned int   SWRST;                 //  0x04  R/W       0x00000000    Software reset register
    volatile unsigned int   DSISEL;                //  0x08  R/W       0x00000000    DSI select register
    volatile unsigned int   INTSEL;                //  0x0C  R/W       0x00000000    Interrupt register
    volatile unsigned int   MEM_EMA;               //  0x10  R/W       0x00000001    Memory EMA register
}MIPIDSBUSCFG, *PMIPIDSBUSCFG;

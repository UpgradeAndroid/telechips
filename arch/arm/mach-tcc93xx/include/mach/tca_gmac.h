...
static void tca_gmac_clk_enable(void)
{
	if(hsio_clk) {
		...
		//clk_set_rate(hsio_clk, 250*1000*1000);
...
static void tca_gmac_portinit(void)
{
	...
	if(machine_is_tcc8800()) 
	{
		...
		BITCSET(pGPIO->GPGFN0, Hw32-Hw0, Hw28|Hw24|Hw20|Hw16|Hw12|Hw8|Hw4|Hw0);//0~7
		...
		//not used 20~27
		//BITCSET(pGPIO->GPGFN2, Hw32-Hw0, Hw28|Hw24|Hw20|Hw16|Hw12|Hw8|Hw4|Hw0);//16~23
		//BITCSET(pGPIO->GPGFN3, Hw16-Hw0, Hw12|Hw8 |Hw4 |Hw0);//24~27

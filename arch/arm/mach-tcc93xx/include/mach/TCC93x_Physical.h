...
********************************************************************************/
/************************************************************************
*   1. Clock Controller Register Define             (Base Addr = 0xB0500000) // R/W
************************************************************************/
...
/************************************************************************
*   2. Timer, Counter Register Define              (Base Addr = 0xB0501000) // R/W
************************************************************************/
#define HwTMR_BASE                                  *(volatile unsigned long*)0xB0501000
...
#define	HwPMU_WKUP_GPIOA19			Hw25
#define	HwPMU_WKUP_GPIOA14			Hw24
#define	HwPMU_WKUP_GPIOA13			Hw23
#define	HwPMU_WKUP_GPIOA18			Hw22
#define	HwPMU_WKUP_GPIOA17			Hw21
#define	HwPMU_WKUP_GPIOA16			Hw20
...
#define	HwPMU_WKUP_GPIOF17			Hw9
#define	HwPMU_WKUP_GPIOF16			Hw8
#define	HwPMU_WKUP_GPIOF28			Hw7
...
/************************************************************************
*   4. SMU I2C Register Define                      (Base Addr = 0xB0505000) // R/W
************************************************************************/
#define HwSMUI2C_BASE                               *(volatile unsigned long*)0xB0505000
#define HwSMUI2C_CH1_BASE                               *(volatile unsigned long*)0xB0505040
#define HwSMU_I2CICLK_BASE                          *(volatile unsigned long*)0xB0505080
...
********************************************************************************/
/************************************************************************
*   1. Multi-layer Bus Matrix Register Define      (Base Addr = 0xB0300000) // R/W
************************************************************************/
...
#define HwDDRIFCFG_BASE                             *(volatile unsigned long*)0xB0303000
...
#define	HwVMT_BASE									*(volatile unsigned long*)0xC0000000
#define	HwREGION_BASE								*(volatile unsigned long*)0xB0307000
...
#define HwGDMA0CH0_BASE                             *(volatile unsigned long*)0xB0030000
#define HwGDMA0CH1_BASE                             *(volatile unsigned long*)0xB0030030
#define HwGDMA0CH2_BASE                             *(volatile unsigned long*)0xB0030060
#define HwGDMA0CONFIG_BASE                          *(volatile unsigned long*)0xB0030090

#define HwGDMA1_BASE                                *(volatile unsigned long*)0xB0030100
#define HwGDMA1CH0_BASE                             *(volatile unsigned long*)0xB0030100
#define HwGDMA1CH1_BASE                             *(volatile unsigned long*)0xB0030130
#define HwGDMA1CH2_BASE                             *(volatile unsigned long*)0xB0030160
#define HwGDMA1CONFIG_BASE                          *(volatile unsigned long*)0xB0030190

#define HwGDMA2_BASE                                *(volatile unsigned long*)0xB0030200
#define HwGDMA2CH0_BASE                             *(volatile unsigned long*)0xB0030200
#define HwGDMA2CH1_BASE                             *(volatile unsigned long*)0xB0030230
#define HwGDMA2CH2_BASE                             *(volatile unsigned long*)0xB0030260
#define HwGDMA2CONFIG_BASE                          *(volatile unsigned long*)0xB0030290

// HSIOBUS
#define HwGDMA3_BASE                                *(volatile unsigned long*)0xB0830000
#define HwGDMA3CH0_BASE                             *(volatile unsigned long*)0xB0830000
#define HwGDMA3CH1_BASE                             *(volatile unsigned long*)0xB0830330
#define HwGDMA3CH2_BASE                             *(volatile unsigned long*)0xB0830360
#define HwGDMA3CONFIG_BASE                          *(volatile unsigned long*)0xB0830390


/************************************************************************
*   7. GPIO Controller Register Define             (Base Addr = 0xB010A000) // R/W
************************************************************************/
#define HwGPIO_BASE                                 *(volatile unsigned long*)0xB010A000
#define HwGPIOA_BASE                                *(volatile unsigned long*)0xB010A000
#define HwGPIOB_BASE                                *(volatile unsigned long*)0xB010A040
#define HwGPIOC_BASE                                *(volatile unsigned long*)0xB010A080
#define HwGPIOD_BASE                                *(volatile unsigned long*)0xB010A0C0
#define HwGPIOE_BASE                                *(volatile unsigned long*)0xB010A100
#define HwGPIOF_BASE                                *(volatile unsigned long*)0xB010A140
#define HwGPIOG_BASE                                *(volatile unsigned long*)0xB010A180
#define HwEINTSEL_BASE                              *(volatile unsigned long*)0xB010A204
#define HwECID_BASE                                 *(volatile unsigned long*)0xB010A190
#define HwSYSMONEN_BASE                             *(volatile unsigned long*)0xB010A18C
...
************************************************************************/
#define HwGPSBCH0_BASE              *(volatile unsigned long*)0xB0107000
#define HwGPSBCH1_BASE              *(volatile unsigned long*)0xB0107100
#define HwGPSBCH2_BASE              *(volatile unsigned long*)0xB0107200
#define HwGPSBCH3_BASE              *(volatile unsigned long*)0xB0107300
#define HwGPSBCH4_BASE              *(volatile unsigned long*)0xB0107400
#define HwGPSBCH5_BASE              *(volatile unsigned long*)0xB0107500
#define HwGPSBPORTCFG_BASE          *(volatile unsigned long*)0xB0107800
#define HwGPSBPIDTABLE_BASE         *(volatile unsigned long*)0xB0107F00

#define	HwGPSB_BASE(X)				*(volatile unsigned long *)(0xB0107000+(X)*0x100)
...
#define	HwGPSB_PIDT(X)				*(volatile unsigned long *)(0xB0107F00+(X)*4)	// R/W, PID Table Register
...
/************************************************************************
*   10. Audio DMA Controller 0 Register Define      (Base Addr = 0xB0103000) // R/W
************************************************************************/
// Audio 0  (7.1 Ch)
...
/************************************************************************
*   11. Audio DMA Controller 1 Register Define      (Base Addr = 0xB0105000) // R/W
************************************************************************/
// Audio 1  (Stereo)
...
#define	HwNFC_CTRL_RDY_RDY			Hw29							// External Nand Flash Controller is Ready
#define	HwNFC_CTRL_RDY_BUSY			~Hw29							// External Nand Flash Controller is Busy
...
#define	HwNFC_CTRL_DNUM				Hw14							// Nand Flash Multiplee Data Configuration Number 
...
#define HwNFC_IRQCFG_RDYIEN			Hw31
#define HwNFC_IRQCFG_PIEN			Hw30
#define HwNFC_IRQCFG_RDIEN			Hw29
...
#define	HwECC_IREQ_MEDFG			Hw7								// MLC ECC Encoding Flag Register
#define	HwECC_IREQ_MEEFG			Hw6								// MLC ECC Decoding Flag Register
#define	HwECC_IREQ_SEDFG			Hw4								// SLC ECC Encoding Flag Register
#define	HwECC_IREQ_SEEFG			Hw3								// SLC ECC Decoding Flag Register

//--------------------------------------------------------------------------------------
// ECC Cotrol Register
//--------------------------------------------------------------------------------------
#define HwECC_BASE/*HwNFCECC_BASE*/                               *(volatile unsigned long*)0xB0050200
...
#define	HwERR_NUM_CORIMP			(Hw4|Hw3|Hw0)					// Correction Impossible(SLC, MLC4)
...
************************************************************************/
#define HwUSB20OTG_BASE                              *(volatile unsigned long*)0xB0040000
// Peripheral Bus CFG
#define HwUSBOTGCFG_BASE                             *(volatile unsigned long*)0xB0080020
#define HwUSBPHYCFG_BASE                             *(volatile unsigned long*)0xB0080024


/************************************************************************
*   14. I2C Controller Register Define              (Base Addr = 0xB0109000) // R/W
************************************************************************/
#define HwI2C_CORE0_BASE                            *(volatile unsigned long*)0xB0109000
#define HwI2C_CORE0_CH1_BASE                            *(volatile unsigned long*)0xB0109040
#define HwI2C_CORE0_SLAVE_BASE                            *(volatile unsigned long*)0xB0109080
#define HwI2C_CORE0_STATUS_BASE                            *(volatile unsigned long*)0xB01090C0

#define HwI2C_CORE1_BASE                            *(volatile unsigned long*)0xB0109100
#define HwI2C_CORE1_CH1_BASE                            *(volatile unsigned long*)0xB0109140
#define HwI2C_CORE1_SLAVE_BASE                            *(volatile unsigned long*)0xB0109180
#define HwI2C_CORE1_STATUS_BASE                            *(volatile unsigned long*)0xB01091C0

#define HwI2C_CORE2_BASE                            *(volatile unsigned long*)0xB0109200
#define HwI2C_CORE2_CH1_BASE                            *(volatile unsigned long*)0xB0109240
#define HwI2C_CORE2_SLAVE_BASE                            *(volatile unsigned long*)0xB0109280
#define HwI2C_CORE2_STATUS_BASE                            *(volatile unsigned long*)0xB01092C0
...
/************************************************************************
*   15. Pulse Density Modulation Register Define    (Base Addr = 0xB0060000) // R/W
************************************************************************/
...
#define HwTSIFPORTSEL_BASE                          *(volatile unsigned long*)0xB0108200

#define HwTSIF0PIDTABLE_BASE						*(volatile unsigned long*)0xB0108008
#define	HwTSIF0_PIDT(X)								*(volatile unsigned long *)(0xB0108008+(X)*4)	// R/W, PID Table Register

#define HwTSIF1PIDTABLE_BASE						*(volatile unsigned long*)0xB0108108
#define	HwTSIF1_PIDT(X)								*(volatile unsigned long *)(0xB0108108+(X)*4)	// R/W, PID Table Register

/************************************************************************
*   19. UART Controller Register Define             (Base Addr = 0xB0102000) // R/W
************************************************************************/
#define HwUART_BASE                                 *(volatile unsigned long*)0xB0102000
#define HwUARTCH0_BASE                              *(volatile unsigned long*)0xB0102000
...
#define HwUART_CH_BASE(X)                           *(volatile unsigned long*)(0xB0102000+(X)*0x100)

#define	HwUART_CHSEL								HwUARTPORTMUX_BASE					// R/W, Channel Selection Register
...
#define HwPIC_BASE                                  HwVPIC_BASE

#define HwPIC										((PPIC)&HwPIC_BASE)
#define HwVIC										((PVIC)&HwVECTINTRCTR_BASE)
...
#define	HwINT0_ISP2      			Hw22 										// R/W, ISP Interrupt Enable
...
#define	HwINT0_RTC					Hw2											// R/W, RTC Interrupt Enable
#define	HwINT0_TC32					Hw1											// R/W, Timer32 Interrupt Enable
#define	HwINT0_TC0					Hw0											// R/W, Timer0 Interrupt Enable

// Interrupt Enable 1
#define HwINT1_ISP1					Hw31										// R/W, ISP1 interrupt enable
#define HwINT1_ISP0					Hw30										// R/W, ISP0 interrupt enable
#define HwINT1_SD2		 			Hw29 										// R/W, SD/MMC 2 Interrupt enable
...
#define HwINT1_AUDIO1					Hw25										// R/W, AUDIO1 interrupt enable
#define HwINT1_ISP3					Hw24										// R/W, ISP3 interrupt enable
#define HwINT1_GMAC 					Hw23										// R/W, GMAC receive interrupt enable
#define HwINT1_TSIF1					Hw22										// R/W, TS interface 1 interrupt enable
#define HwINT1_TSIF0					Hw21										// R/W, TS interface 0 interrupt enable
#define HwINT1_CIPHER 					Hw20										// R/W, Cipher interrupt enable
#define HwINT1_ADMA1 					Hw19										// R/W, AUDIO DMA1 expired interrupt enable

#define HwINT1_UOTG1					Hw17										// R/W, USB 2.0 OTG1 interrupt Enable
#define HwINT1_UOTG 					Hw16										// R/W, USB 2.0 OTG interrupt enable
#define HwINT1_UART 					Hw15										// R/W, UART interrupt enable
#define HwINT1_SD3		 			Hw14 										// R/W, SD/MMC 3 Interrupt enable
#define HwINT1_SD1					Hw13										// R/W, SD/MMC 1 interrupt enable
#define HwINT1_SD0					Hw12										// R/W, SD/MMC 0 interrupt enable
#define HwINT1_SMUI2C					Hw11										// R/W, SMCI2C interrupt enable
...
#define HwINT1_CKC					Hw7 										// R/W, CKC interrupt enable
...
#define HwINT1_MIPID	 				Hw1 										// R/W, MIPID Interrupt Enable
...
************************************************************************/
//#define HwIOBUSCFG_BASE                           *(volatile unsigned long*)0xB0800000 !!Error!!
...
#define HwUSB20OTG1_BASE                             *(volatile unsigned long*)0xB0800000
// Peripheral Bus CFG
#define HwUSBOTG1CFG_BASE                            *(volatile unsigned long*)0xB0880010
#define HwUSBPHY1CFG_BASE                            *(volatile unsigned long*)0xB0880014
...
/************************************************************************
*   5-1. Memory Stick Controller Config Register Define (Base Addr = 0xB0870100) // R/W
*************************************************************************/
#define HwMSTICKCFG_BASE                            *(volatile unsigned long*)0xB0870100

/************************************************************************
*   6, 7, 8. SATA Controller Register Define              (Base Addr = 0xB0810000) // R/W
*************************************************************************/
...
#define HwSATAPHY0_BASE					HwSATAPHY_BASE
...
/************************************************************************
*   11-1. HSIO Bus Matrix Register Define           (Base Addr = 0xB0870200) // R/W
*************************************************************************/
...
#define HwLCDC0_CH_BASE(X)			*(volatile unsigned long *)(0xB0A00000 + 0x80 + (0x38 * X))
#define HwLCDC1_CH_BASE(X)			*(volatile unsigned long *)(0xB0A04000 + 0x80 + (0x38 * X))
...
#define HwM2MSCALER0_BASE                           *(volatile unsigned long*)0xB0A10000
#define HwM2MSCALER1_BASE                           *(volatile unsigned long*)0xB0A20000
...
#define HwM2MSCALER_CFG0			*(volatile unsigned long*)0xB0A10014
#define HwM2MSCALER_CFG1			*(volatile unsigned long*)0xB0A20014
...
#define	HwTVE_BASE					                HwTVENCODER_BASE

#define HwTVE_VEN_BASE								*(volatile unsigned long*)0xB0A40800
...
#define HwDDI_CONFIG_BASE							HwDDICFG_BASE
...
#define HwDDI_CACHE_BASE                            HwDDICACHE_BASE
...
********************************************************************************/
/************************************************************************
*   4,5,6,7. JPEG Codec / Video Codec Register Define            (Base Addr = 0xB0900000) // R/W
*************************************************************************/

/************************************************************************
*   4. JPEG Encoder Register Define                              (Base Addr = 0xB0980000) // R/W
*************************************************************************/
#define HwJPEGENCODER_BASE                          *(volatile unsigned long*)0xB0980000
...
/************************************************************************
*   5. Video Codec Register Define                               (Base Addr = 0xB0900000) // R/W
*************************************************************************/
#define HwVIDEOCODEC_BASE                           *(volatile unsigned long*)0xB0900000


/************************************************************************
*   6. Video Cache Register Define                               (Base Addr = 0xB0910000) // R/W
*************************************************************************/
...
/************************************************************************
*   7. Video Bus Register Define                                 (Base Addr = 0xB0910000) // R/W
*************************************************************************/
#define HwVIDEOBUSCFG_BASE                          *(volatile unsigned long*)0xB0920000
#define HwVIDEOBUSCFG								((PVIDEOBUSCFG)&HwVIDEOBUSCFG_BASE)
...
// EINT  by kch
#define HwEINTSEL2_EINT15(X)		((X)*Hw24)									// EINT15 Source Selection
#define HwEINTSEL2_EINT15_MASK		HwEINTSEL2_EINT11(0x7F)
#define HwEINTSEL2_EINT14(X)		((X)*Hw16)									// EINT14 Source Selection
#define HwEINTSEL2_EINT14_MASK		HwEINTSEL2_EINT10(0x7F)
#define HwEINTSEL2_EINT13(X) 		((X)*Hw8)									// EINT13 Source Selection
#define HwEINTSEL2_EINT13_MASK		HwEINTSEL2_EINT9(0x7F)
#define HwEINTSEL2_EINT12(X) 		((X)*Hw0)									// EINT12 Source Selection
#define HwEINTSEL2_EINT12_MASK		HwEINTSEL2_EINT8(0x7F)
#define HwEINTSEL2_EINT11(X)		((X)*Hw24)									// EINT11 Source Selection
#define HwEINTSEL2_EINT11_MASK		HwEINTSEL2_EINT11(0x7F)
#define HwEINTSEL2_EINT10(X)		((X)*Hw16)									// EINT10 Source Selection
#define HwEINTSEL2_EINT10_MASK		HwEINTSEL2_EINT10(0x7F)
#define HwEINTSEL2_EINT9(X) 		((X)*Hw8)									// EINT9 Source Selection
#define HwEINTSEL2_EINT9_MASK		HwEINTSEL2_EINT9(0x7F)
#define HwEINTSEL2_EINT8(X) 		((X)*Hw0)									// EINT8 Source Selection
#define HwEINTSEL2_EINT8_MASK		HwEINTSEL2_EINT8(0x7F)
...
typedef enum
{
	...
	SEL_GPIOA15,	SEL_GPIOA16, 	SEL_GPIOA17, 	SEL_GPIOB17, 	SEL_GPIOB19, 	// 15
	SEL_GPIOB26, 	SEL_GPIOB27,	SEL_GPIOB30,	SEL_GPIOB31,	SEL_GPIOC18,	// 20
	SEL_GPIOC19,	SEL_GPIOC20,	SEL_GPIOC21,	SEL_GPIOC22,	SEL_GPIOC23,	// 25
	SEL_GPIOC28,	SEL_GPIOC29,	SEL_GPIOC30,	SEL_GPIOC31,	SEL_GPIOD15,	// 30
	SEL_GPIOD16,	SEL_GPIOD17,	SEL_GPIOD18,	SEL_GPIOD19,	SEL_GPIOD20, 	// 35
	SEL_GPIOD21,	SEL_GPIOD22,	SEL_GPIOD23,	SEL_GPIOD24,	SEL_GPIOD25, 	// 40
	SEL_GPIOE10,	SEL_GPIOE11,	SEL_GPIOE24,	SEL_GPIOE25,	SEL_GPIOE26,	// 45
	SEL_GPIOE27, 	SEL_GPIOE28,	SEL_GPIOE29, 	SEL_GPIOE30, 	SEL_GPIOE31,	// 50
	SEL_GPIOF16,	SEL_GPIOF17,	SEL_GPIOF26, 	SEL_GPIOF27, 	SEL_GPIOF28,     // 55
	SEL_GPIOG4 ,	SEL_GPIOG5,		SEL_GPIOG6, 	SEL_GPIOG7, 	SEL_GPIOG11,     // 60
	SEL_GPIOG12,	SEL_GPIOG17,	SEL_GPIOG22, 	SEL_GPIOG23, 	SEL_GPIOG24,     // 65	
	SEL_GPIOG25,	SEL_GPIOG26,	SEL_GPIOG27, 	SEL_GPIOG28, 	SEL_GPIOG29,     // 70		
	SEL_TSWKU,		SEL_TSSTOP,		SEL_TSUPDN, 	SEL_RMWKUP, 	SEL_USB1_VBON,     // 75			
	SEL_USB1_VBOFF,	SEL_USB0_VBON,	SEL_USB0_VBOFF					// 80
} ESEL;
...
*************************************************************************/
#define HwCEM_BASE                          		*(volatile unsigned long*)0xB0200100
...
*************************************************************************/
#define HwCSC_BASE                            		*(volatile unsigned long*)0xB0200200
...
*************************************************************************/
#define HwISPBASE                                  *(volatile unsigned long*)0xB0210000
...
#define RegISP_BASE									0xB0210000
/*************************************************************************
*   6. Camera Bus Configuration Register Define     (Base Addr = 0xB0230000) // R/W
*************************************************************************/
#define HwCAMBUSCFG_BASE                            *(volatile unsigned long*)0xB0230000
...
********************************************************************************/
/*************************************************************************
*   4, 5. MIPI Register Define                      (Base Addr = 0xB0230000) // R/W
*************************************************************************/

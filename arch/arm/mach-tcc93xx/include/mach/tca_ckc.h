...
/****************************************************************************************
* FUNCTION :void tca_ckc_validpll(unsigned int * pvalidpll012, unsigned int * pvalidpll345)
* DESCRIPTION :
* ***************************************************************************************/
extern VOLATILE void tca_ckc_validpll(unsigned int * pvalidpll012, unsigned int * pvalidpll345);
...
* DESCRIPTION : Power Down Register of DDI_CONFIG 
* ***************************************************************************************/
extern int tca_ckc_getvideobuscfgpwdn(unsigned int lpwdn);
...
/****************************************************************************************
* FUNCTION :int tca_ckc_sethsiobus(unsigned int sel, unsigned int mode)
* DESCRIPTION :
* ***************************************************************************************/
extern VOLATILE void tca_ckc_sethsiobus(unsigned int sel, unsigned int mode);

/****************************************************************************************
* FUNCTION :int tca_ckc_gethsiobus(unsigned int sel)
* DESCRIPTION :
* ***************************************************************************************/
extern VOLATILE int tca_ckc_gethsiobus(unsigned int sel);

/****************************************************************************************
* FUNCTION :int tca_ckc_sethsiobusswreset(unsigned int sel, unsigned int mode)
* DESCRIPTION :
* ***************************************************************************************/
extern VOLATILE void tca_ckc_sethsiobusswreset(unsigned int sel, unsigned int mode);
/****************************************************************************************
...
extern VOLATILE void tca_ckc_setcambuspwdn(unsigned int sel, unsigned int mode);
extern VOLATILE void tca_ckc_setcambusswreset(unsigned int sel, unsigned int mode);

extern VOLATILE void tca_ckc_setddisubbus(unsigned int sel, unsigned int mode);
extern VOLATILE void tca_ckc_setddisubbusswreset(unsigned int sel, unsigned int mode);
...
extern int tca_ckc_set_mem_freq(unsigned int freq);

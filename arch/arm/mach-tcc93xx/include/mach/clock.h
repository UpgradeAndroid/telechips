/*
 * arch/arm/mach-tcc93xx/include/mach/clock.h
 *
...
#ifndef __TCC93XX_CLOCK_H
#define __TCC93XX_CLOCK_H
...
struct clk {
	...
	void (*pwdn)(unsigned int, unsigned int);
	unsigned int swreset_idx;
	void (*swreset)(unsigned int, unsigned int);

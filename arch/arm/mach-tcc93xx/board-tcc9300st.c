/*
 * linux/arch/arm/mach-tcc93xx/board-tcc9300st.c
 *
...
#if defined(CONFIG_MACH_TCC9300ST)
static struct atsc_i2c_platform_data  atsc_i2c_data = {
};
#endif
...
static struct i2c_board_info __initdata i2c_devices2[] = {
	{
		I2C_BOARD_INFO("tcc-atsc", (0x32 >> 1)),
		.platform_data = &atsc_i2c_data,
	}
};
#endif
...
static void tcc9300st_nand_init(void)
{
...
static int tcc9300st_nand_ready(void)
{
...
struct tcc_nand_platform_data tcc_nand_platdata = {
	...
	.init		= tcc9300st_nand_init,
	.ready		= tcc9300st_nand_ready,
};
...
MACHINE_START(TCC9300ST, "tcc9300st")
